...
initial_announcements = [
    {
        "title": "Spring showcase registration window is open",
        "message": "Families can still enroll students in clubs and teams for the spring showcase. Review the updated activity list and reserve spots before they close.",
        "start_date": None,
